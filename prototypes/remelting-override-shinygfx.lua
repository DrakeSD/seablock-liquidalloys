local function iconset(name,suf,tier)
	data.raw["item"][name..suf].icons = {
		{
			icon = "__seablock-liquidalloys__/graphics/icons/"..name.."-gfx"..tier..".png",
		},
		{
	...
	if data.raw["assembling-machine"]["alloy-mixer"] then
		...
		data.raw["assembling-machine"]["alloy-mixer"].animation = {
			layers = {
				...
				{
					filename = "__seablock-liquidalloys__/graphics/entity/alloy-mixer/alloy-mixer-gfx-1.png",
					width = 224,
					height = 256,
					line_length = 6,
					frame_count = 36,
	...
	if data.raw["assembling-machine"]["alloy-mixer-2"] then
		...
		data.raw["assembling-machine"]["alloy-mixer-2"].animation = {
			layers = {
				...
				{
					filename = "__seablock-liquidalloys__/graphics/entity/alloy-mixer/alloy-mixer-gfx-2.png",
					width = 224,
					height = 256,
					line_length = 6,
					frame_count = 36,
	...
	if data.raw["assembling-machine"]["alloy-mixer-3"] then
		...
		data.raw["assembling-machine"]["alloy-mixer-3"].animation = {
			layers = {
				...
				{
					filename = "__seablock-liquidalloys__/graphics/entity/alloy-mixer/alloy-mixer-gfx-3.png",
					width = 224,
					height = 256,
					line_length = 6,
					frame_count = 36,
	...
	if data.raw["assembling-machine"]["alloy-mixer-4"] then
		...
		data.raw["assembling-machine"]["alloy-mixer-4"].animation = {
			layers = {
				...
				{
					filename = "__seablock-liquidalloys__/graphics/entity/alloy-mixer/alloy-mixer-gfx-4.png",
					width = 224,
					height = 256,
					line_length = 6,
					frame_count = 36,
